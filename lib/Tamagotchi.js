...
class Pet {
	...
	constructor () {
		this.hunger = 0
		this.happy = 80
		this.fav_hunger = [':ramen:', ':pizza:']
		this.hates_hunger = ['apple']
	...
	play (game) {
		this.increase_happy()
		chance(0.5) ? this.reduce_hunger(10) : this.reduce_hunger(5) 
	}
